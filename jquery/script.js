$(function () {
  ...
  //var jsOfNewItemForm;
  //jsOfNewItemForm = document.getElementById('newItemForm');
  $newItemButton = $("#newItemButton"); // Cache button to show form

  $("li")
    .hide() //this starts all li as hidden so that we can fade them in nicely
    .each(
      //iterarate through our array of all list item
      function (
        index //defining & calling a f/n (IIFE)
      ) {
